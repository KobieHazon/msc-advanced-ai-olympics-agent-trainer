# here lies an example of how to is_train an RL agent
...
def main(args):
    ...
    record_win = deque(maxlen=100)  # TODO: should take?
        ...
        while True:
            ...
            if not done:  # reward shaping, here we simply penality every time step
                ...
                if reward[0] != reward[1]:
                    post_reward = [reward[0] - 100, reward[1]] if reward[0] < reward[1] else [reward[0],
                                                                                              reward[1] - 100]
                else:
                    post_reward = [-1., -1.]
